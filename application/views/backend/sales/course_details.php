<ol class="breadcrumb bc-3">
    ...
    <li><a href="<?php echo site_url('sales/courses'); ?>"><?php echo get_phrase('courses'); ?></a> </li>
                ...
                <table class="table table-bordered datatable" id="table-1">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                    $sales_details = $this->user_model->get_sales_details()->row_array();
                                    echo $sales_details['first_name'].' '.$sales_details['last_name'];
                                ?>
                            </td>
                        </tr>
