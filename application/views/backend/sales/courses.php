        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('courses'); ?>
                    <a href="<?php echo site_url('sales/course_form/add_course'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_course'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
            ...
            <div class="card-body p-0">
                <div class="row no-gutters">
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('sales/courses'); ?>" class="text-secondary">
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row justify-content-center" action="<?php echo site_url('sales/courses'); ?>" method="get">
                    <!-- Course Categories -->
                    <div class="col-xl-3">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?php echo ++$key; ?></td>
                                    <td>
                                        <strong><a href="<?php echo site_url('sales/course_form/course_edit/'.$course['id']); ?>"><?php echo ellipsis($course['title']); ?></a></strong><br>
                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                          ...
                                          <ul class="dropdown-menu">
                                              ...
                                              <li><a class="dropdown-item" href="<?php echo site_url('sales/course_form/course_edit/'.$course['id']); ?>"><?php echo get_phrase('edit_this_course');?></a></li>
                                              <?php if($course['course_type'] != 'scorm'): ?>
                                                  <li><a class="dropdown-item" href="<?php echo site_url('sales/course_form/course_edit/'.$course['id']); ?>"><?php echo get_phrase('section_and_lesson');?></a></li>
                                              <?php endif; ?>
                                              <li>
                                                  <?php if ($course['status'] == 'active'): ?>
                                                      ...
                                                      <?php else: ?>
                                                          <a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url();?>sales/change_course_status_for_sales/pending/<?php echo $course['id']; ?>/<?php echo $selected_category_id; ?>/<?php echo $selected_instructor_id; ?>/<?php echo $selected_price; ?>/<?php echo $selected_status;?>', '<?php echo get_phrase('inform_instructor'); ?>');">
                                                              <?php echo get_phrase('mark_as_pending');?>
                                                          </a>
                                                      <?php endif; ?>
                                                  <?php else: ?>
                                                      ...
                                                      <?php else: ?>
                                                          <a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url();?>sales/change_course_status_for_sales/active/<?php echo $course['id']; ?>/<?php echo $selected_category_id; ?>/<?php echo $selected_instructor_id; ?>/<?php echo $selected_price; ?>/<?php echo $selected_status;?>', '<?php echo get_phrase('inform_instructor'); ?>');">
                                                              <?php echo get_phrase('mark_as_active');?>
                                                          </a>
                                                      <?php endif; ?>
                                                  <?php endif; ?>
