        ...
        <div class="card">
            <div class="card-body">
              ...
              <div class="row justify-content-md-center">
                  <div class="col-xl-6">
                      <form class="form-inline" action="<?php echo site_url('sales/enrol_history/filter_by_date_range') ?>" method="get">
                          <div class="col-xl-10">
                          ...
                          <tbody>
                              <?php foreach ($enrol_history->result_array() as $enrol):
                                  ...
                                  <tr class="gradeU">
                                      ...
                                      <td><strong><a href="<?php echo site_url('sales/course_form/course_edit/'.$course_data['id']); ?>" target="_blank"><?php echo $course_data['title']; ?></a></strong></td>
