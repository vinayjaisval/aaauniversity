        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="<?php echo site_url('sales/preview/'.$course_id); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm ml-1 my-1" target="_blank"><?php echo get_phrase('view_on_frontend'); ?> <i class="mdi mdi-arrow-right"></i> </a>

                        <a href="<?php echo site_url('sales/courses'); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm my-1"> <i class=" mdi mdi-keyboard-backspace"></i> <?php echo get_phrase('back_to_course_list'); ?></a>
                    </div>
                </div>

                <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form" action="<?php echo site_url('sales/course_actions/edit/'.$course_id); ?>" method="post" enctype="multipart/form-data">
                            <div id="basicwizard">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control select2" data-toggle="select2" name="level" id="level">
                                                        <?php foreach ($levels as $level): ?>
                                                                <option value="<?php echo $level; ?>" <?php if ($course_details['level'] == $level)echo 'selected';?>><?php echo ucfirst($level); ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
                            ...
                            <div class="row">
                                   ...
                                   <div class="col-md-6">
                                       <ul class="list-inline mb-0 wizard " style="text-align:right;">
                                    <li class="previous list-inline-item">
                                      <button type="button" class="btn btn-primary text-center" onclick="checkRequiredFields()"><?php echo get_phrase('submit'); ?></button>
                                    </li>
...
function ajax_get_sub_category(category_id) {
    ...
    $.ajax({
        url: '<?php echo site_url('sales/ajax_get_sub_category/');?>' + category_id ,
