        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"><i
                            class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('view_student'); ?>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
                                            ...
                                            if (sizeof($instructors_lists) > 1) {
                                                if ($instructors_list['id'] == $instructors_id) {
                                                    if ($result[0]['is_instructor'] == "1") {
                                                        if ($instructors_list['id'] == $user_id) {
                        ...
                        <div class="col-12">
                            <div class="table-responsive-sm mt-1">
                                <table class="table table-striped table-centered mb-0">
                                    <thead>
                                    <th class="col-2"><h4>#</h4></th>
                                    <th class="col-10"><h4>Name</h4></th>
                                    </thead>
