<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title">
                    <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('attendance_add'); ?>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-3"><?php echo get_phrase('attendance_add'); ?></h4>
                <form class="required-form" action="<?php echo site_url('user/attendance_form/add/'); ?>"
                                        ...
                                        foreach ($batch_data as $key => $batch_model_list):
                                            ...
                                            if (sizeof($r) > 1) {
                                                foreach ($r as $re) {
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $result[0]['id']; ?>"><?php echo $result[0]['title'] ?></option>
                                                    <?php
                                                }
                                            } else {
                                ...
                                <div class="col-md-9">
                                    <select class="form-control select2" data-toggle="select2" name="course_name"
                                        ...
                                        foreach ($courses_data as $key => $course_lists):
                                            ?>
                                            <option value="<?php echo $course_lists['id']; ?>"><?php echo $course_lists['title'] ?></option>
                                        <?php
                                        endforeach;
                                        ?>
                                    </select>
                                ...
                                <div class="text-center">
                                    <div class="mb-3">
                                        <button type="button" class="btn btn-primary" onclick="checkRequiredFields()"
                                                name="button"><?php echo get_phrase('attendance start'); ?></button>
                                    </div>
                                </div>
                            </div> <!-- end col -->
                        </div> <!-- end row -->
