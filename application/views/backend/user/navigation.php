...
<div class="left-side-menu left-side-menu-detached">
	...
	<ul class="metismenu side-nav side-nav-light">
		...
		<?php if ($this->session->userdata('is_instructor')) : ?>
			...
			<li class="side-nav-item">
				<a href="<?php echo site_url('user/batch_alert'); ?>" class="side-nav-link <?php if ($page_name == 'batch_alert') echo 'active'; ?>">
					<i class="dripicons-user-group"></i>
					<span><?php echo get_phrase('batch_alot'); ?></span>
				</a>
			</li>
			<li class="side-nav-item">
				<a href="<?php echo site_url('user/attendance'); ?>" class="side-nav-link <?php if ($page_name == 'attendance') echo 'active'; ?>">
					<i class="fa-edit"></i>
					<span><?php echo get_phrase('attendance'); ?></span>
				</a>
			</li>
			<li class="side-nav-item">
				<a href="<?php echo site_url('user/salary_slip'); ?>" class="side-nav-link <?php if ($page_name == 'salary_slip') echo 'active'; ?>">
					<i class="fa fa-money-bill"></i>
					<span><?php echo get_phrase('salary_slip'); ?></span>
				</a>
			</li>
		<?php else : ?>
			<li class="side-nav-item">
