        ...
        <div class="card-body">
            ...
            <form class="" action="<?php echo site_url('admin/payment_settings/razorpay_settings'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label><?php echo get_phrase('test_mode'); ?></label>
                    <select class="form-control select2" data-toggle="select2" id = "testmode" name="testmode">
                        <option value="on" <?php if ($razorpay[0]->testmode == 'on') echo 'selected';?>> <?php echo get_phrase('on');?></option>
                        <option value="off" <?php if ($razorpay[0]->testmode == 'off') echo 'selected';?>> <?php echo get_phrase('off');?></option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" data-toggle="select2" id = "razorpay_currency" name="razorpay_currency" required>
                        <option value=""><?php echo get_phrase('select_razor_currency'); ?></option>
                        <?php
                        $currencies = $this->crud_model->get_stripe_supported_currencies();
                        foreach ($currencies as $currency):?>
                        <option value="<?php echo $currency['code'];?>"
            ...
            <div class="form-group">
                <label><?php echo get_phrase('test_public_key'); ?></label>
                <input type="text" name="public_key" class="form-control" value="<?php echo $razorpay[0]->public_key;?>" required />
            </div>

            <div class="form-group">
                <label><?php echo get_phrase('live_secret_key'); ?></label>
                <input type="text" name="secret_live_key" class="form-control" value="<?php echo $razorpay[0]->secret_live_key;?>" required />
            </div>

            <div class="form-group">
                <label><?php echo get_phrase('live_public_key'); ?></label>
                <input type="text" name="public_live_key" class="form-control" value="<?php echo $razorpay[0]->public_live_key;?>" required />
            </div>
...
<div class="col-md-5">
    <div class="alert alert-info" role="alert">
        ...
        <p><?php echo get_phrase('please_make_sure_that').' "'.get_phrase('system_currency').'", '.'"'.get_phrase('paypal_currency').'" and '.'"'.get_phrase('stripe_currency').'" '.get_phrase('are_same').'"'.get_phrase('razorpay_currency'); ?>.</p>
    </div>
</div>
</div>
