...
$name_text = explode(",", $course_details['user_id']);

// print_r($name_text);die;

// foreach ($name_text as $value) {
//     print_r($value);die;

// }
// foreach($name_text as $key=> $cat) {
//     $cat = trim($cat);
//   echo $cat; die;
// }
?>
                                ...
                                <div class="tab-content b-0 mb-0">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <!-- <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div>
                                                            <img class="rounded-circle" src="https://demo.creativeitem.com/academy-addon/uploads/user_image/c5e5de4316c794f425a65eecfe1b1240.jpg" height="30px" alt="">

                                                            <?php



                                                            foreach ($get_user->result_array() as $user) : ?>
                                                                <span style="font-weight: 700; font-size: 15px; vertical-align: sub; margin-left: 6px;">
                                                                    <?php

                                                                    if ($course_details['user_id'] == $user['id']) echo 'selected';
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2" name="new_instructors[]" id="new_instructor" multiple required>
                                                            <option value=""><?php echo get_phrase('select_a_instructor'); ?></option>
                                                            <?php foreach ($get_user->result_array() as $key => $user) : ?>

                                                                <option value="<?php echo $user['id']; ?>" <?php foreach ($name_text as $key => $value) : ?> <?php if ($value == $user['id']) echo 'selected'; ?> <?php endforeach; ?>><?php echo $user['first_name'];
                                                                                                                                                                                                                                        ?></option>
                                                            <?php endforeach; ?>

                                                        </select>
                                                        <!-- <span class="select2 select2-container select2-container--default select2-container--below select2-container--focus" dir="ltr" data-select2-id="1" style="width: 1px;"><span class="selection"><span class="select2-selection select2-selection--multiple" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2" name="sub_category_id" id="sub_category_id" required>
                                                            ...
                                                            foreach ($categories->result_array() as $sub_category) : ?>
                                                                <option value="<?php echo $sub_category['id']; ?>" <?php if ($course_details['sub_category_id'] == $sub_category['id']) echo 'selected'; ?>><?php echo $sub_category['name']; ?></option>
                                                            <?php endforeach; ?>
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="short_description"><?php echo get_phrase('course_duration'); ?></label>
                                                    <div class="col-md-10">
                                                        <textarea name="course_duration" id="course_duration" class="form-control"><?php echo $course_details['course_duration']; ?></textarea>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane" id="media">
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-xl-8">
                                                <img src="<?php echo base_url() . 'uploads/thumbnails/course_thumbnails/'.$course_details['thumbnail']?>" style="height: 100px">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <input type="hidden" class="form-control" name="course_thumbnail_old" value="<?php echo $course_details['thumbnail']?>" id="course_thumbnail" >
                                                    </div>
                                                </div>
                                            </div>
