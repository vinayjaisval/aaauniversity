    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('sales_prson_add_form'); ?></h4>

                <form class="required-form" action="<?php echo site_url('admin/sales_persons/add'); ?>" enctype="multipart/form-data" method="post">
