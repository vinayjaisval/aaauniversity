        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/frontend_settings/frontend_update'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="about_us_mission"><?php echo get_phrase('about_us_mission'); ?></label>
                        <textarea name="about_us_mission" id = "about_us_mission" class="form-control" rows="5"><?php echo get_frontend_settings('about_us_mission'); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="about_us_vision"><?php echo get_phrase('about_us_Vision'); ?></label>
                        <textarea name="about_us_vision" id = "about_us_vision" class="form-control" rows="5"><?php echo get_frontend_settings('about_us_vision'); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="about_us_values"><?php echo get_phrase('about_us_values'); ?></label>
                        <textarea name="about_us_values" id = "about_us_values" class="form-control" rows="5"><?php echo get_frontend_settings('about_us_values'); ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="privacy_policy"><?php echo get_phrase('cancellation_and_refund_policy'); ?></label>
                        <textarea name="cancellation_and_refund_policy" id = "cancellation_and_refund_policy" class="form-control" rows="5"><?php echo get_frontend_settings('cancellation_and_refund_policy'); ?></textarea>
                    </div>
...
<script type="text/javascript">
  $(document).ready(function () {
    initSummerNote(['#about_us','#about_us_mission','#about_us_vision','#about_us_values', '#terms_and_condition', '#privacy_policy', '#cancellation_and_refund_policy', '#cookie_policy']);
  });
</script>