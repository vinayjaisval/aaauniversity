...
<div class="col-xl-8">
  <div class="form-group row mb-3">
    ...
    <label class="col-md-2 col-form-label" for="<?php echo $course_media; ?>_label">
      <?php echo get_phrase($course_media); ?>
    </label>
      ...
      <div class="wrapper-image-preview" style="margin-left: -6px;">
        <div class="box" style="width: 250px;">
          ...
          <div class="js--image-preview"
               style="background-image: url(<?php echo $this->crud_model->get_course_thumbnail_url($course_details['id'], $course_media) . '?v=' . time(); ?>);
               background-color: #F5F5F5;">
          </div>

          <div class="upload-options">
            <label for="<?php echo $course_media; ?>" class="btn">
            ...
            <input id="<?php echo $course_media; ?>"
                   style="visibility:hidden;"
                   type="file"
                   class="image-upload"
                   name="<?php echo $course_media; ?>"
                   accept="image/*">
          </div>
