                                    ...
                                    <div class="tab-pane" id="basic">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="course_duration"><?php echo get_phrase('course_duration'); ?></label>
                                                    <div class="col-md-10">
                                                        <textarea name="course_duration" id="course_duration" class="form-control"></textarea>
                                                    </div>
                                                </div>
