        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title">
                    ...
                    <?php echo get_phrase('total_attendance_of_' . $instructor_name); ?>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                ?>
                <h4 class="mb-3 col-xl-6 header-title float-left"><?php echo get_phrase('attendance_list'); ?></h4>
                <h4 class="mb-3 col-xl-6 header-title float-left" id="total_time"><?php echo get_phrase('total_time :-  ') ?></h4>
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="completed-b1">
                        ...
                        <div class="row justify-content-md">
                            <div class="col-xl-12">
                                <form class="form-inline" action="<?php echo site_url('admin/attendance_list/filter_date') ?>" method="get">
                                    <div class="col-xl-5">
                        ...
                        <div class="table-responsive-sm mt-4">
                            <table id="basic-datatable" class="table table-striped table-centered mb-0">
                                ...
                                <tbody>
                                    ...
                                    foreach ($attendance_data as $key => $attendance_list) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!---->
                                                <!--                                                <h4>-->
                                                <!--                                                    <a href="--><?php //$instructor_id = $attendance_list['instructor_id'];  echo site_url("admin/attendance_list/attendance_complete/$id/$instructor_id"); 
                                                                                                                    ?>
                                                <!--"-->
                                            ...
                                            <td>
                                                <div class="dropright dropright">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <!--                                                   href="-->
                                                        <?php //echo site_url('admin/attendance_form/view_attendance/' . $attendance_list['id']) 
                                                        ?>
                                                        <!--">-->
                                                        <?php //echo get_phrase('view_students'); 
                                                        ?>
                                                        <!--</a>-->
                                                        <!--                                            </li>-->

                                                        <!-- /**************** Edit And Delete Button ***************/ -->
                                                        <li><a class="dropdown-item" href="<?php echo site_url('admin/attendance_list/edit_attendance/' . $attendance_list['id'] . '/' . $attendance_list['instructor_id']) ?>">
                                                                <?php echo get_phrase('edit_attendance'); ?></a>
                                                        </li>

                                                        <li>
                                                            <?php
                                                            if ($attendance_list['status'] == 1) {
                                                            ?>
                                                                <a class="dropdown-item" href="<?php echo site_url('admin/attendance_list/status_pending/' . $attendance_list['id'] . '/' . $attendance_list['instructor_id']) ?>">
                                                                    <?php echo get_phrase('status_pending'); ?></a>
                                                            <?php
                                                            } else {
                                                                //
                                                            ?>
                                                                <a class="dropdown-item" href="<?php echo site_url('admin/attendance_list/status_approved/' . $attendance_list['id'] . '/' . $attendance_list['instructor_id']) ?>">
                                                        ...
                                                        <li><a class="dropdown-item" href="<?php echo site_url('admin/attendance_list/delete/' . $attendance_list['id'] . '/' . $attendance_list['instructor_id']) ?>">
                                    ...
                                    <?php
                                        $t = $this->lazyload->total_data($attendance_list['start_time'], $attendance_list['end_time']);
                                        $hour = $hour + $t['hours'];
                                        $total_time = $total_time + $t['min'];
                                    endforeach;

                                    $hours = floor($total_time / 60);
                                    $hours = $hours + $hour;
                                    $reminder = $total_time % 60;
                                    ?>

                                    <script>
                                        document.getElementById('total_time').innerText = "Total Time :- <?php echo $hours . " hour : " . $reminder . " minutes" ?>";
                                    </script>
                                </tbody>
                            </table>
                        </div>
