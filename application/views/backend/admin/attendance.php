        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"><i
                        class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('attendance'); ?>
                ...
                <div class="table-responsive-sm mt-4">
                    <table id="basic-datatable" class="table table-striped table-centered mb-0">
                        ...
                        <tr>
                            ...
                            <th><?php echo get_phrase('total number of attendance'); ?></th>
                        ...
                        foreach ($instructors as $key => $user): ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo $this->crud_model->total_number_of_attendance_by_month($user['id'])?>
                                </td>
                                <td>
                                    <div class="dropright dropright">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="<?php echo site_url('admin/attendance_list/'.$user['id']) ?>"><?php echo get_phrase('total_attendance'); ?></a></li>
