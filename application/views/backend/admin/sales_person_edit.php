    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('sales_prson_edit_form'); ?></h4>

                <form class="required-form" action="<?php echo site_url('admin/sales_persons/edit/'.$user_id); ?>" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <small><?php echo get_phrase("required_for_sales_prson"); ?></small>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
