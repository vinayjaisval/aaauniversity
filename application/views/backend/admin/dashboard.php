...
$num_enquiry= $this->db->get('enquiry')->num_rows();
?>
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="page-title"><i
                            class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('dashboard'); ?>
                    <a href="<?php echo site_url('admin/enquiry/view_page'); ?>"
                       class="btn btn-outline-primary btn-rounded alignToTitle"><i class="fa fa-question-circle"></i>
                        <span style="color: #f88171"><?php echo $num_enquiry ?></span></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
