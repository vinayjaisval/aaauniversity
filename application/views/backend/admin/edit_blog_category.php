        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"><i
                            class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('edit_blog_category'); ?>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
            ...
            <div class="card-body">
                <div class="col-lg-12">
                    <h4 class="mb-3 header-title">
                        <?php echo get_phrase('blog_category_add_form'); ?>
                    </h4>

                    <form class="required-form" action="<?php echo site_url('admin/form_blog_category/edit/'.$edit_blog_category[0]['slug']); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="title"
                                   value="<?php echo $edit_blog_category[0]['title'] ?>" required>
                        </div>
                        ...
                        <div class="form-group" id="icon-picker-area">
                            ...
                            <input type="text" id="font_awesome_class" name="font_awesome_class"
                                   value="<?php echo $edit_blog_category[0]['icon'] ?>" class="form-control icon-picker"
                                   autocomplete="off">
                        </div>
