...
$user_location_data = $this->db->get_where('user_location', array('user_id' => $user_id))->row_array();


$state = $this->db->get_where('states', array('country_id' => '101'))->result_array();
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/instructors/edit/' . $user_id); ?>"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                         ...
                                         <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="first_name"><?php echo get_phrase('designation'); ?> <span class="required">*</span> </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="designation" name="designation" value="<?php echo $user_data['designation']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label"
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control" id="state_drop_down" name="state" required>
                                                    <?php foreach ($state as $state_list): ?>
                                                        <option value="<?php echo $state_list['id'] ?>" <?php echo ($state_list['id'] == $user_location_data['state_id']) ? 'selected' : '' ?> ><?php echo $state_list['name'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control" id="city_drop_down" name="city" required>
                                                    ...
                                                    foreach ($cities as $city_list): ?>
                                                        <option value="<?php echo $city_list['id'] ?>" <?php echo ($city_list['id'] == $user_location_data['city_id']) ? 'selected' : '' ?> ><?php echo $city_list['name'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <textarea name="biography" id="summernote-basic"
                                                          class="form-control"><?php echo $user_data['biography']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label"
                            ...
                            <div class="tab-pane" id="payment_info">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label"
                                                   for="facebook_link"> <?php echo get_phrase('paypal_secret_key'); ?></label>
                                            <div class="col-md-9">
                                                <input type="text" id="paypal_secret_key" name="paypal_secret_key"
                                                       class="form-control"
                                                       value="<?php echo $paypal_keys[0]['production_secret_key']; ?>">
                                                <small><?php echo get_phrase("required_for_instructor"); ?></small>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="stripe_public_key" name="stripe_public_key"
                                                       class="form-control"
                                                       value="<?php echo $stripe_keys[0]['public_live_key']; ?>">
                                                <small><?php echo get_phrase("required_for_instructor"); ?></small>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="stripe_secret_key" name="stripe_secret_key"
                                                       class="form-control"
                                                       value="<?php echo $stripe_keys[0]['secret_live_key']; ?>">
                                                <small><?php echo get_phrase("required_for_instructor"); ?></small>
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
...
<script type="text/javascript">
    ...
    $(document).ready(function (){
        let selected_state_id = "<?php echo $user_location_data['state_id']?>"
        let country_id = '101';
        ...
        $.ajax({
            ...
            success: function (state) {
                ...
                for (let key in state) {
                    if (state !== "") {
                        let state_dropdown = `<option value="${state[key]['id']}" ${(selected_state_id == state[key]['id'])?'selected':''}>${state[key]['name']}</option>`;
    ...
    /******* Change country than use this code  multi-comment ********/
    /*
    ...
    */
    ...
    /******* Change country than use this code ********/
