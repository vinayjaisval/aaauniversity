...
<div class="hero-banner hero-style-8" style="min-height: 541px;">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="banner-content">
                    ...
                    <p style="color:#002069"> <b>Job-oriented courses to make you industry ready </b> </p>
                    <div class="banner-search" data-sal-delay="400" data-sal="slide-up" data-sal-duration="1000">
            ...
            <div class="col-lg-6">
                <div class="banner-thumbnail">
                    ...
                    <div class="instructor-info" data-sal-delay="600" data-sal="slide-up" data-sal-duration="1000">
                        <div class="inner">
                            <h5 class="title"> <b>Instructors </b></h5>
                            <div class="media">
                                <div class="thumb">
                                    <!--                                    <img src="-->
                                    <?php //echo base_url() . 'assets/frontend/default/assets/images/banner/author-1.png' ?><!--"-->
                                    <!--                                         alt="Images">-->
<!--                                    <div class="row">-->
<!--                                        <div class="col-md-2">-->
<!--                                            <a href="#"><img-->
<!--                                                        src="--><?php //echo base_url('assets/frontend/default/assets/images/others/boy.png') ?><!--"-->
<!--                                                        style="height: 42px;" alt="Images"> </a>-->
<!--                                        </div>-->
<!--                                        <div class="col-md-2">-->
<!--                                            <a href="#"><img-->
<!--                                                        src="--><?php //echo base_url('assets/frontend/default/assets/images/others/girl.png') ?><!--"-->
<!--                                                        style="height: 42px;" alt="Images"> </a>-->
<!--                                        </div>-->
<!--                                        <div class="col-md-2">-->
<!--                                            <a href="#"><img-->
...
<!--                                    </div>-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-2"  style="padding: 0px;">
                                            <a href="#"><img src="<?php echo base_url('assets/frontend/default/assets/images/others/boy.png') ?>" class="sq" style="width: 50px;border: 3px solid #aeaeae;border-radius: 30px;background: #ff6a06;" alt="Images"> </a>
                                        </div>
                                        <div class="col-md-2 col-2" style="padding: 0px;">
                                            <a href="#"><img src="<?php echo base_url('assets/frontend/default/assets/images/others/girl.png') ?>" class="sq" style="width: 50px;position: relative;left: -13px;border: 3px solid #aeaeae;border-radius: 30px;background: #ff6a06;" alt="Images"></a>
                                        </div>
                                        <div class="col-md-2 col-2" style="padding: 0px;">
                                            <a href="#"><img src="<?php echo base_url('assets/frontend/default/assets/images/others/boy.png') ?>" class="sq" style="width: 50px;position: relative;left:-26px;border: 3px solid #aeaeae;border-radius: 30px;background: #ff6a06;" alt="Images"> </a>
                                        </div>
                                        <div class="col-md-2 col-2" style="padding: 0px;">
                                            <a href="#"><img src="<?php echo base_url('assets/frontend/default/assets/images/others/girl.png') ?>" class="sq" style="width: 50px;position: relative;left:-38px;border: 3px solid #aeaeae;border-radius: 30px;background: #ff6a06;" alt="Images"> </a>
                                        </div>
<!--                                        <div class="col-md-2 col-2" style="padding: 0px;">-->
<!--                                            <a href="#"><img src="--><?php //echo base_url('assets/frontend/default/assets/images/others/boy.png') ?><!--" class="sq" style="width: 50px;position: relative;left:-50px;border: 3px solid #aeaeae;-->
<!--border-radius: 30px;background: #ff6a06;" alt="Images"> </a>-->
<!--                                        </div>-->
                                        <div class="col-md-2 col-2">
                                            <a href="#"><img src="<?php echo base_url('assets/frontend/default/assets/images/others/pl.png') ?>" style="width: 62px;position: relative;left:-70px;top: 6px;border: 3px solid #aeaeae;border-radius: 30px;background: #ff6a06;" alt="Images"> </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="content">
                                    <span style="color: #00266c;font-size: 43px;">

                                        <?php
                                        $num = $this->user_model->get_instructor()->num_rows();
                                        echo "$num+";
                                        ?>
                                    </span>
    <a href="<?php echo base_url('home/get_instructor') ?>" style="font-size: 15px;"> <b>View All Instructors </b></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="testimonial-area-2 ">
    <div class="container edublink-animated-shape">
        ...
        <ul class="shape-group">
            <li class="shape-1 scene" data-sal-delay="200" data-sal="fade" data-sal-duration="1000">
                <img data-depth="1.4"
                     src="<?php echo base_url() . 'assets/frontend/default/assets/images/about/shape-30.png' ?>"
                     alt="Shape">
            </li>
            <li class="shape-2 scene" data-sal-delay="200" data-sal="fade" data-sal-duration="1000">
                <img data-depth="-1.4"
                     src="<?php echo base_url() . 'assets/frontend/default/assets/images/about/shape-25.png' ?>"
                     alt="Shape">
            </li>
        </ul>
    </div>
    <ul class="shape-group">
        <li class="shape-3" data-sal-delay="200" data-sal="fade" data-sal-duration="1000">
            <img src="<?php echo base_url() . 'assets/frontend/default/assets/images/others/map-shape-3.png' ?>"
                 alt="Shape">
        </li>
    </ul>
</div>
