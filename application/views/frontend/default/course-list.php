...
// ==========================================
/*
$this->db->where('FIND_IN_SET("'.$course['id'].'",course_id) <>','0')->limit(1)->order_by('id',"DESC");
$qw = $this->db->get('ck_webinar')->result_object()[0]->course_id;
$start_date = $this->db->get('ck_webinar')->result_object()[0]->start_time;
echo $last_date = $this->db->get('ck_webinar')->result_object()[0]->end_time;
*/
$flag=0;
$dis=0;
                       ...
                       <div class="edu-course course-style-4 course-style-8">
                           <div class="inner">
                               ...
                               <div class="content">
                                   ...
                                   <h6 class="title">
                                       <a href="course-details.php">React - The Complete Guide (incl Hooks, React, Redux)</a>
                                   </h6>
                                   <div class="course-rating">
                                       <div class="rating">
                                           <i class="icon-23"></i>
                       ...
                       <div class="edu-course course-style-4 course-style-8">
                           <div class="inner">
                               ...
                               <div class="content">
                                   <div class="course-price">$29.00</div>
                                   <h6 class="title">
                                       <a href="course-details.php">Microsoft Excel - Excel from Beginner to Advanced</a>
                                   </h6>
                                   <div class="course-rating">
                                       <div class="rating">
                                           <i class="icon-23"></i>
                       ...
                       <div class="edu-course course-style-4 course-style-8">
                           <div class="inner">
                               ...
                               <div class="content">
                                   <div class="course-price">$29.00</div>
                                   <h6 class="title">
                                       <a href="course-details.php">Adobe Premiere Pro CC Master-class: Video Editing</a>
                                   </h6>
                                   <div class="course-rating">
                                       <div class="rating">
                                           <i class="icon-23"></i>
                       ...
                       <div class="edu-course course-style-4 course-style-8">
                           <div class="inner">
                               ...
                               <div class="content">
                                   <div class="course-price">$29.00</div>
                                   <h6 class="title">
                                       <a href="course-details.php">Build Responsive Real-World Websites with HTML & CSS</a>
                                   </h6>
                                   <div class="course-rating">
                                       <div class="rating">
                                           <i class="icon-23"></i>
                       ...
                       <div class="edu-course course-style-4 course-style-8">
                           <div class="inner">
                               ...
                               <div class="content">
                                   <div class="course-price">$29.00</div>
                                   <h6 class="title">
                                       <a href="course-details.php">C Programming For Beginners - Master the C Language</a>
                                   </h6>
                                   <div class="course-rating">
                                       <div class="rating">
                                           <i class="icon-23"></i>
                       ...
                       <div class="edu-course course-style-4 course-style-8">
                           <div class="inner">
                               ...
                               <div class="content">
                                   <div class="course-price">$29.00</div>
                                   <h6 class="title">
                                       <a href="course-details.php">Vue - The Complete Guide (w/ Router, Composition API)</a>
                                   </h6>
                                   <div class="course-rating">
                                       <div class="rating">
                                           <i class="icon-23"></i>
                       ...
                       <div class="edu-course course-style-4 course-style-8">
                           <div class="inner">
                               ...
                               <div class="content">
                                   <div class="course-price">$29.00</div>
                                   <h6 class="title">
                                       <a href="course-details.php">Master Microservices with Spring Boot & Spring Cloud</a>
                                   </h6>
                                   <div class="course-rating">
                                       <div class="rating">
                                           <i class="icon-23"></i>
