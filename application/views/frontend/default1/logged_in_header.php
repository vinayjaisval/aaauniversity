                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <!-- <?php if (get_settings('allow_instructor') == 1) : ?>
                        <div class="instructor-box menu-icon-box">
                            <div class="icon">
                                <a href="<?php echo site_url('user'); ?>" style="border: 1px solid transparent; margin: 10px 10px; font-size: 14px; width: 100%; border-radius: 0;"><?php echo site_phrase('Become instructor'); ?></a>
                            </div>
                        </div>
                    <?php endif; ?> -->
                            ...
                            <ul class="user-dropdown-menu">
                                ...
                                <?php if (get_settings('allow_instructor') == 1) : ?>
                                    ...
                                    <li class="user-dropdown-menu-item">
                                        <a href="<?php echo site_url('user'); ?>"><i class="fas fa-user"></i><?php echo site_phrase('Become instructor'); ?></a>
                                        <!-- </div> -->
                                        <!-- </div> -->
                                    </li>
                                <?php endif; ?>
