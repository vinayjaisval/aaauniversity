...
class Login extends CI_Controller
{
    ...
    public function validate_login($from = "")
    {
        ...
        if ($query->num_rows() > 0) {
            ...
            if ($row->role_id == 1) {
                ...
                redirect(site_url('sales/dashboard'), 'refresh');
            } else if ($row->role_id > 3) {
                redirect(site_url('home/login'), 'refresh');
            }
        } 
    ...
    public function register_old()
    {
        ...
        /*** For send a password on email  ***/
        $this->session->set_userdata('pass_temp', $this->input->post('password'));
...
public function register()
{
    ...
    public function verify_email_address()
    {
        ...
        if ($user_details->num_rows() > 0) {
            ...
            $pass_temp = $this->session->userdata('pass_temp');
            $this->email_model->new_register_student($user_details['id'],$pass_temp);
