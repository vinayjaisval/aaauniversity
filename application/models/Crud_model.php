...
//            die();
    ...
    {
        $this->db->where('web_status', 'waiting');
            return $this->db->get('ck_webinar');
      
    }
    public function getTextboxValue($selectedValue) {
        // Fetch the corresponding textbox value from the database based on the selected dropdown value
        $query = $this->db->get_where('ck_webinar', ['title' => $selectedValue]);
        $result = $query->row();
...
//            print_r($this->db->get_compiled_select());
    ...
    /********************* Chanchal End Code *********************/
    public function get_all_webinar_upcoming()
    {  $this->db->where('web_status','waiting');
   
        return $this->db->get("ck_webinar");
    }
    public function get_all_webinar_completed()
    {
        {  $this->db->where('web_status','completed');
    ...
    public function get_webinar_by_id($param)
    {
        $this->db->where('id', $param);
        return $this->db->get('ck_webinar');        
    }
    public function get_webinar_by_staus($param)
    {
        $this->db->where('web_status', $param);
        return $this->db->get('ck_webinar');        
    }
    public function get_webinar_amount_by_id($result)
    { 
        $this->db->where('id', $result);     
        return $this->db->get('ck_webinar');                   
    }
    function getlink($postData){
        $data = json_encode($postData);
        $this->db->insert('ck_webinar', $data);
